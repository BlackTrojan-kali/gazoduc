...
class ArticleController extends Controller
{
    ...
    public function index(){
        $articles = Article::where("entreprise_id",Auth::user()->entreprise_id)->where("type","!=","produit_petrolier")->with("entreprise")->orderBy("created_at","desc")->paginate(15);
    ...
    public function delete($idAr){
        ...
        if($num > 0 || $article->type == "matiere_premiere"){
        
        return back()->with("error","cet article ne peut plus etre supprime");
    }
        $article->delete();
