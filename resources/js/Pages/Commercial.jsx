...
const Commercial = ({ ceos, roles,entreprises,agencies }) => {
...
console.log(ceos)
  ...
  return (
    <>
      <Head title='Magasin' />
      Liste des Directeurs Commerciaux
      <br /><br />
...
Commercial.layout = page => <AppLayout children={page} />;
