...
const Prodindex = ({ stocks, articles, agencies }) => { // Ajoutez articles et agencies comme props si ce n'est pas déjà fait
...
Prodindex.layout = page => <ProdLayout children={page} />;
