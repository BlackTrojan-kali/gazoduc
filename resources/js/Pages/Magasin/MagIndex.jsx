...
import { faCartPlus, faPlus } from '@fortawesome/free-solid-svg-icons'; // Importez l'icône plus
...
const MagIndex = ({ stocks, articles, agencies,clients,articlePrices }) => { // Ajoutez articles et agencies comme props si ce n'est pas déjà fait
