...
const Production = ({ ceos, roles,entreprises,agencies }) => {
...
console.log(ceos)
  ...
  return (
    <>
      <Head title='Magasin' />
      Liste des Directeurs Production
      <br /><br />
              ...
              {ceos.data && ceos.data.length > 0 ? (
                ceos.data.map((ceo) => (
                  <TableRow key={ceo.id} className="">
                    ...
                    <TableCell className="py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                      {ceo.agency ? ceo.agency.name : ""} {/* Accès sécurisé à agencies.length */}
                    </TableCell>
                    <TableCell className="py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                      {ceo.code || 'N/A'}
                    </TableCell>
...
Production.layout = page => <AppLayout children={page} />;
