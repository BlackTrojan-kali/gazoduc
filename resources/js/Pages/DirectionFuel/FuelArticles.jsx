...
const FuelArticles = ({ articles, entreprises,simpleArticles }) => {
...
FuelArticles.layout = page => <DirFuelLayout children={page} />;
export default FuelArticles;