...
const PageContent = ({ factures, clients, articles, agencies,articlePrices }) => {
...
const  ComSales = ({ factures, clients, articles, agencies,articlePrices })=>{
  const {auth}= usePage().props
  if(auth.user.role == "commercial"){
    return(
      <ComLayout>
        <PageContent factures={factures} clients={clients} articles={articles} articlePrices={articlePrices} agencies={agencies}/>
      </ComLayout>
    )
  }
  if(auth.user.role = "magasin"){
    return(
    <MagLayout>
    <PageContent factures={factures} clients={clients} articles={articles} agencies={agencies} articlePrices={articlePrices}/>
    </MagLayout>
    )
  }
}
