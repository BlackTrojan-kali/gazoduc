...
const PageContent = ({ factureItems, articles, agencies, onPageChange, onFilterChange }) => {
    ...
    // Fonction pour gérer les changements de filtre de manière plus robuste
    const handleFilterChange = (filterName, value) => {
        const newFilters = { ...filters, [filterName]: value, page: 1 };
        setFilters(newFilters);
        // C'est ici que les filtres sont envoyés au composant parent
        // pour qu'il puisse mettre à jour la liste des articles.
        if (onFilterChange) {
