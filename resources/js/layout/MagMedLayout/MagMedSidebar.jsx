...
const navItems = [
  {
    ...
    name: "Dashboard",
    subItems: [
      { name: "Stocks", path: "/mag-med", pro: false }, 
      { name: "Mouvements", path: "/mag-med/production", pro: false },
    ],
  },{
    icon:  <FontAwesomeIcon icon={faTimeline} />,
    name: "Transferts",
    subItems: [
      { name:"Historique", path: "/dispatch", pro: false },
    ],
  },
