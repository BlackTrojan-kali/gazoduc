...
const navItems = [
  {
    ...
    name: "Dashboard",
    subItems: [
      { name:"Gases", path: "/gases", pro: false },
      { name: "Cylinder Types", path: "/cylinder-types", pro: false }, 
      { name: "Citernes", path: "/storage-tanks", pro: false },
      {name:"Cylinders",path:"/cylinders"},
    ],
  },{
