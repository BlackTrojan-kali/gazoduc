...
import { faChevronDown, faCoins, faDashboard, faDollar, faDotCircle, faDriversLicense, faGlobe,  faUser,  } from "@fortawesome/free-solid-svg-icons";
...
const navItems = [
  {
    ...
    name: "Dashboard",
    subItems: [
      { name:"statistiques", path: "/commercial-page-index", pro: false },
    ],
  },
  {
