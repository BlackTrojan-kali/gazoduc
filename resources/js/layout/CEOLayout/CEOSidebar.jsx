...
const navItems = [
  {
    ...
    name: "Dashboard",
    subItems: [
      { name:"dashbaord", path: "/ceo-index", pro: false },
      { name:"chiffre d'affaire", path: "/ceo-ca", pro: false },
    ],
  },{
    icon:  <FontAwesomeIcon icon={faBank} />,
    name: "Versements",
    subItems: [
      { name:"versements", path: "/ceo-payment", pro: false },
      { name:"vente d'articles", path: "/ceo-articles", pro: false },
    ],
  }
];
