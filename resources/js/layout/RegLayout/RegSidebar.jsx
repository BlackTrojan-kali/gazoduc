...
import { faChevronDown, faDashboard, faDotCircle, faDriversLicense, faGlobe,  faIndustry,  faMoneyBill,  faRepeat,  faSave,  faUser,  } from "@fortawesome/free-solid-svg-icons";
...
const navItems = [
  {
    ...
    name: "Stocks",
    subItems: [
      { name:"Stocks", path: "/controlleur-index", pro: false },
      { name: "citernes", path: "/controlleur-citerne", pro: false },
    ],
  },
  {
