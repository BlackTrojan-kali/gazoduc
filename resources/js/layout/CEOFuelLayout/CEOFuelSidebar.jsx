...
import { faBank, faChevronDown, faDashboard, faDotCircle, faDriversLicense, faGlobe,  faRepeat,  faUser,  } from "@fortawesome/free-solid-svg-icons";


const navItems = [
  {
    icon:  <FontAwesomeIcon icon={faDashboard} />,
    name: "Dashboard Carburant",
    subItems: [
      { name:"dashbaord", path: "/ceo-fuel-index", pro: false },
      { name:"Stock ", path: "/ceo-fuel-stock", pro: false },
    ],
  },  {
    icon:  <FontAwesomeIcon icon={faBank} />,
    name: "Versements",
    subItems: [
      { name:"versements consolidee", path: "/ceo-fuel-payments", pro: false },
    ],
  },
];
