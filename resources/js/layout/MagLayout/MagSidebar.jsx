...
import { faChevronDown, faCoins, faDashboard, faDollar, faDotCircle, faDriversLicense, faGlobe,  faRepeat,  faUser,  } from "@fortawesome/free-solid-svg-icons";
...
const MagSidebar = () => {
  ...
  if(auth.user.licence=="gaz et petrol"){
    salesRoutes=
   {
