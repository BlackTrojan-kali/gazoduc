...
const Modal = ({ isOpen, onClose, children, title }) => {
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[999999] flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none bg-gray-900/20 dark:bg-white/10 bg-opacity-70"
