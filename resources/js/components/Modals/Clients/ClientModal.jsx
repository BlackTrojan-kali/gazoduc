...
{/*agence du client */}
<div>
            <label htmlFor="" className='text-black dark:text-white mb-3'>Agences:<span className="text-red-500 ml-1">*</span></label>
            <Select options={agenciesOption} onChange={e=>handleSelectChange(e)} className='text-black mt-2'/>
