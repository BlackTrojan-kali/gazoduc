...
<head>
    <meta charset="UTF-8">
    <title>Déclaration Manuelle CSPH</title>
    <style>
        ...
        .badge-manual { border: 1px solid #718096; padding: 3px 8px; border-radius: 4px; display: inline-block; margin-top: 5px; }
    </style>
</head>
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="5" class="text-center">Aucune ligne saisie.</td>
                </tr>
            @endforelse
    ...
    <div class="footer">
        Document généré par l'ERP Ikarootech.<br>
        <div class="badge-manual">SAISIE MANUELLE DES DONNÉES</div><br>
        Ce rapport a été établi sur la base des déclarations libres de l'utilisateur.
    </div>
