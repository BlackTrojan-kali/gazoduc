    ...
    <div class="container">
        ...
        <div>
            <div class="header-left">
                <img src="{{ public_path('images/logo-erp.png') }}" alt="Logo"
                    style="max-width: 120px; margin-bottom: 10px;"><br>
        ...
        <h1>Facture N° 7</h1>
        <p style="text-align: right;"><strong>Date de facturation :</strong>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        Frais de location de la licence d'exploitation <strong>IKAROOTECH ERP</strong>
                        ({{ $licence->name }})<br>
                        <em>Période : du {{ \Carbon\Carbon::parse($start)->format('d/m/Y') }} au
                            {{ \Carbon\Carbon::parse($newExpirationDate)->format('d/m/Y') }}</em>
                    </td>
        ...
        <div>
            ...
            <div class="totals-section">
                <table>
                    ...
                    <tr>
                        <th>NET À PAYER :</th>
                        <td style="font-size: 16px; border-top: 2px solid #000;">
                            {{ number_format($total, 0, ',', ' ') }} FCFA</td>
                    </tr>
                </table>
            </div>
            <div class="clear"></div>
