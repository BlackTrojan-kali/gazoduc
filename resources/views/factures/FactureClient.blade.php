...
<body>
    <div class="container">
        <div class="header">
            <img src={{public_path("images/clients/".$entreprise->logo_path)}} alt="">
            <div>
                <h1>Facture</h1>
                <p>N° Facture: <b>{{ $facture->id }}</b></p>
        ...
        <div class="invoice-details">
            ...
            <div>
                ...
                <p>Enregistrée par: <b>{{ $facture->user->first_name." ".$facture->user->last_name }}</b></p>
            </div>
        </div>
