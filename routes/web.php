...
use App\Http\Controllers\CsphReportController;
...
// Routes pour le module CSPH
Route::get('/direction/csph', [FactureController::class, 'csphIndex'])->name('direction.csph.index');
Route::get('/direction/csph/export', [FactureController::class, 'exportCsphPdf'])->name('direction.csph.export');
// NOUVELLE ROUTE POUR L'EXPORT MANUEL
Route::post('/direction/csph/export-manual', [FactureController::class, 'exportManualPdf'])->name('direction.csph.export-manual');
